...
import com.milkski.createplenty.fluids.SulfuricAcidBlock;
import com.milkski.createplenty.items.SulfuricBoneMealItem;
...
public class CreateBopCompatibilityMod {
    ...
    public static final String MODID = "createplenty";
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> CREATE_BOP_BRIDGE_TAB = CREATIVE_MODE_TABS.register("example_tab", () -> CreativeModeTab.builder()
            .title(Component.translatable("itemGroup.createplenty")) //The language key for the title of your CreativeModeTab
